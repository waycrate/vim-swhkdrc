...
syn match swCommand "^\s.*$" containedin=ALL contains=@Shell,swSequenceShell
...
syn region swSequenceShell matchgroup=swBrace start=/{/ end=/}/ contained keepend oneline contains=swKeysym,swSequenceSep
syn region swInlineComment start="#" end="$" contained

hi def link swComment Comment
hi def link swInlineComment Comment
hi def link swModifier Keyword
